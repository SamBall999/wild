    ...
    if config is not None:
        if isinstance(config, DictConfig):
            ...
            if "Resize" not in config.keys() and image_size is not None:
                ...
                print("Resize %s added!", (resize_height, resize_width))
        ...
        transforms = A.Compose(transforms_list, additional_targets={"image": "image", "depth_image": "image"},  is_check_shapes = False)
